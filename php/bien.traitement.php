...
if (isset($_POST['insert'])) {
...
} elseif (isset($_POST['gounbien'])) {
    header("location:../pages/unbien.pages.php?idBien={$_POST['gounbien']}");
    ...
    header("location:../pages/unbien.pages.php?idBien={$idb}");
}
